...
export class FavoritesView extends Favorites {
  ...
  onadd() {
    const addButton = this.root.querySelector(".searchBar button")
    addButton.onclick = () => {
  ...
  createRow() {
    ...
    tr.innerHTML = `
            <td class="user">
              <img
                src="https://github.com/gabezin.png"
                alt="Imagem do usuário"
              />
              <a href="https://github.com/gabezin" target="_blank">
              <p>Daniel Gabriel</p>
              <span>gabezin</span>
            </td>
            <td class="repository">17</td>
